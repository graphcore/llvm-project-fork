...
// Defined in divsi3_worker.c
__attribute__((target("worker")))
si_int __divsi3(si_int a, si_int b);

// Defined in divsi3_supervisor.c
__attribute__((target("supervisor")))
si_int __supervisor_divsi3(si_int a, si_int b);
...
__attribute__((target("supervisor")))
si_int __supervisor_modsi3(si_int a, si_int b) {
  return a - __supervisor_divsi3(a, b) * b;
}
